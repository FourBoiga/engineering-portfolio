...
**ALU** – Supports all arithmetic and logic operations, built from 1-bit slices, combined into a 16-bit ALU. Shifters are 
integrated to support shift operations efficiently.  
